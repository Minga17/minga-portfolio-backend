...
PROJECTS = [
    ...
    },
    {
        ...
        "what_i_did": "Downloaded 8.2 million rows of World Bank data from Kaggle, cleaned and filtered to 53 African countries and 6 key indicators using Python. Wrote 6 SQL queries in DB Browser for SQLite. Built 4 pivot tables and charts in Excel. Published 4 interactive story charts in Tableau Public. Power BI executive dashboard in progress.",
        "insights": [
            ...
            "Morocco leads Africa in internet usage growth among the broader continent.",
        ],
